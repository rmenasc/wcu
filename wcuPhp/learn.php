...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-book"></i> Learn</b></h5>
  </header>
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half" id="txtHint">
        ...
        $conn = new MySql();
        $db = new Database($conn->getConn());
        $store = new SchoolStore($db);
        $schools = $store->getSchools("id LIKE '%'");
        $block = new SchoolBlock();
        $title = "Schools";
        echo $block->getBlock($title, $schools);
        ?>
      </div>
      <div class="w3-half">
        <?php
